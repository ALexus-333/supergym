...
var _localStorage = require("./modules/local-storage");
var _showCard = require("./modules/show-card");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _video.initPlayClick)();
  (0, _tabs.initTabBtnClick)();
  (0, _trainersSlider.createTrainersSlider)();
  (0, _reviewsSlider.createReviewsSlider)();
  (0, _localStorage.initFormSubmit)();
  (0, _showCard.initCardClick)();
...
},{"./modules/local-storage":2,"./modules/modals/init-modals":3,"./modules/reviews-slider":5,"./modules/show-card":6,"./modules/tabs":7,"./modules/trainers-slider":8,"./modules/video":9,"./utils/ios-vh-fix":12}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initFormSubmit = void 0;
...
},{"../../utils/focus-lock":10,"../../utils/scroll-lock":14}],5:[function(require,module,exports){
"use strict";
...
var createReviewsSlider = function createReviewsSlider() {
  return new _swiper.default(reviewsSwiper, {
    navigation: {
...
},{"../vendor/swiper":15}],6:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initCardClick = void 0;
var cards = document.querySelectorAll('.trainers__item');
var clickOnCard = function clickOnCard(event) {
  ...
  var cardTitle = cardPhoto.querySelector('p');
...
var initCardClick = function initCardClick() {
  var isByClick = false;
...
exports.initCardClick = initCardClick;
...
exports.initTabBtnClick = void 0;
var _removeClass = require("../utils/remove-class");
var tabBtns = document.querySelectorAll('.tabs__btn');
var tabLists = document.querySelectorAll('.tabs__list');
var initTabBtnClick = function initTabBtnClick() {
  (0, _removeClass.removeClass)(tabBtns);
  (0, _removeClass.removeClass)(tabLists);
...
exports.initTabBtnClick = initTabBtnClick;

},{"../utils/remove-class":13}],8:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createTrainersSlider = void 0;
var _swiper = _interopRequireDefault(require("../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
...
var createTrainersSlider = function createTrainersSlider() {
  return new _swiper.default(trainersSwiper, {
    navigation: {
...
exports.createTrainersSlider = createTrainersSlider;

},{"../vendor/swiper":15}],9:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initPlayClick = void 0;
var playBtn = document.querySelector('.video__play');
var iframe = document.querySelector('.video__iframe');
var initPlayClick = function initPlayClick() {
  if (playBtn && iframe) {
...
exports.initPlayClick = initPlayClick;
...
},{"./ios-checker":11}],15:[function(require,module,exports){
"use strict";
